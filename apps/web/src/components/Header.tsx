...
export function Header({ apiStatus }: { apiStatus: string }) {
  return (
    <header style={{ background: '#0f172a', color: '#fff', padding: '1rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderRadius: '8px' }}>
      <div>
        <h2 style={{ margin: 0, fontSize: '20px' }}>Enterprise AI Recruitment Platform 💼🤖</h2>
        <span style={{ fontSize: '12px', color: '#94a3b8' }}>Autonomous Candidate Resume Parser & Technical Interview Synthesizer</span>
      </div>
